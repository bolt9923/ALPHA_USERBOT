...
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(
        message,
" ᴀʙᴇ ɢᴀɴᴅᴜ😂😂...ᴘᴀʜᴄʜᴀɴᴀ 𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴘᴀᴘᴀ ʜᴜ ᴛᴜᴍʜᴀʀᴀ👻 ",
    )
...
async def hello_world(client: Client, message: Message):
    ...
    await mg.edit("ᴛᴏᴘɪ")
    await asyncio.sleep(0.3)
    await mg.edit(" ᴊᴏʀ sᴇ ʙᴏʟᴏ 𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴘᴀᴘᴀ ᴊɪ ᴊᴀɪ💘")
...
async def hajqag(client: Client, message: Message):
    ...
    await message.edit("Calling ㅤ 𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 (𝐁ᴀᴀᴘ of telegram)......")
    animation_chars = [
        "`Connecting To Telegram #_ᴀʟᴘʜᴀ`",
        "`Call Connected.`",
        "`𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥: Hello ʙᴏʟ ᴍᴄ. ᴋᴏɴ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ ʜᴀɪ ᴛᴜ...ʙsᴅᴋᴇ ᴋʏᴀ ᴋᴀᴀᴍ ʜᴀɪ ᴛᴇʀᴀ..?`",
        ...
        "ㅤ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ🍃 :ᴏᴋᴀʏ sɪʀ ʙᴜᴛ ᴘᴇʜʟᴇ #_𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴋᴀ ʙᴇᴛᴀ ᴋᴏɴ ʜᴀɪ ᴛᴜ?...😎`",
        f"`ᴍᴇ: ᴀʙᴇ ᴢʜᴀᴛᴜ, ɪ ᴀᴍ` {DEFAULTUSER} ",
        "`ㅤ ➻𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 : ᴀʙᴇ ғᴀᴛᴇ ʜᴜʏᴇ ᴄᴏɴᴅᴀᴍ ᴋᴇ ɴᴀᴛɪᴊᴇ...🤣🤣\nʙsᴅᴋᴇ ɢʜᴀʀ ᴍᴇ ɢʜᴜsᴋᴇ ᴛᴇʀɪ ᴀᴍᴍᴀ ʙᴇʜᴇɴ ᴋᴀ ʀᴇᴘ ᴋᴀʀᴅᴜɴɢᴀ ᴢʜᴀᴛᴜ😜.`",
        "`ᴍᴇ: ᴀʙᴇ ʙsᴅᴋᴇ... ᴛᴇʟᴇɢʀᴀᴍ #_➻𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ ᴋɪ #_➻𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴛᴇʟᴇɢʀᴀᴍ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ...?😜.`",
        "`ㅤ𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 : ʙᴇᴛᴇ...!! ɴᴀᴀ ᴊᴀᴍɪɴ ᴘᴇ ɴᴀ ᴀᴀsᴍᴀɴ ᴘᴇ...😉😉 ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ᴄʜʜᴏᴅᴜɴɢᴀ ᴍᴇ #_𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴋᴇ ʜᴀᴠᴇʟɪ ᴘᴇ...🥵🥵.`",
        "`ᴍᴇ: ʙʜᴀɪ...ʏᴀᴀʀ ᴍᴇʀɪ ɢᴀᴀɴᴅ ᴍᴀʀᴏ ʙᴜᴛ ᴍᴜᴊʜᴇ ᴍᴀғ ᴋᴀʀᴏ...🤯`",
        "`ㅤ ➻𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 : ʜɪʜɪʜɪ... ʏᴇ ʜᴜɪ ɴᴀ ʙᴀᴀᴛ....😁😁\nᴄʜᴀʟ ᴀᴀʙ ᴀᴀᴘɴɪ ʀᴀɴᴅɪ ᴍᴀʏʏᴀ ᴋᴏ #_𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴋᴇ ᴠᴄ ᴘᴇ ʙᴜʟᴀ ᴋᴇ ʟᴏᴠᴇ ᴜ ʙᴏʟɴᴇ  ᴋᴏ ʙᴏʟ😛😛.`",
        "`ᴍᴇ: ʙʜᴀɪ ᴘʟᴢ ɢᴀʟɪ ᴍᴛ ᴅᴏ😥.`",
        "`ㅤ 𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥: ᴛᴏ #_➻𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴀᴜʀ...ᴄʜᴀʟ ʙʜᴀɢ ʏᴀʜᴀ sᴇ ᴍᴄ..ʙsᴅᴋᴇ ᴋᴇ ᴘʜɪʀ ᴄᴀʟʟ ᴋɪʏᴀ ᴛᴏ 𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴋɪ ᴠᴄ ᴘᴇ ᴛᴇʀᴇ ʙᴀᴀᴘ ᴋɪ ᴄʜᴜᴛ ᴍᴀʀᴜɴɢᴀ..🤣🤣  \n🙈𝐓ɢ 𝐏ᴇ 𝐑ᴇʜɴᴀ 𝐇ᴀɪ 𝐓ᴏ🧐 ➻ ⏤͟͞ 𝙆𝙄𝙍𝙈𝘼𝘿𝘼⏤͟͞ ┈➤ ⌯ ❰ #𝙇𝙊𝙍𝘿 ❱ 𝐊ᴏ 𝐁ᴀᴀᴘ💞ᴋᴀʜɴᴀ ʜᴀɪ🤪 @X1OWNER👻 :)`",
        "`ᴘʀɪᴠᴀᴛᴇ ᴄᴀʟʟ ᴅɪsᴄᴏɴɴᴇᴄᴛᴇᴅ....ᴊᴏʀ sᴇ ʙᴏʟᴏ 𓆩𝗠𝗥𓆪 🇸 𝗛 𝗜 𝗡 𝗖 𝗛 𝗔 𝗡❤️‍🔥 ᴘᴀᴘᴀ ᴊɪ ᴊᴀɪ🤣🤣🤣`",
    ] 
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
